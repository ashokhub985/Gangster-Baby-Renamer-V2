...
async def add_caption(client, message):
    ...
    try:
        ...
        print(f"Error while adding caption for user {message.chat.id}: {e}")
...
async def delete_caption(client, message):
    try:
        ...
        print(f"Error while deleting caption for user {message.chat.id}: {e}")
...
async def see_caption(client, message):
    try:
        ...
        print(f"Error while fetching caption for user {message.chat.id}: {e}")
